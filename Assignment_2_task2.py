...
def unzip(**context):
   with ZipFile("{path}{year}_data.zip", 'r') as zObject: 
...
def plot_geomaps(values):
    ...
    os.makedirs('{path}/results/plots', exist_ok=True)
    
    plt.savefig(f'{path}results/plots{values[0]}_heatmap_plot.png')
